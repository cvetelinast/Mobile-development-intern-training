...
public class Board {
    ...
    public void personMove(int i) {
        boardWithSymbols.put(i, GameActivity.variants.get(GameActivity.personSymbol));
    ...
    public int computerMove() {
        ...
        final char computerSymbol = GameActivity.variants.get(!GameActivity.personSymbol);
        boardWithSymbols.put(computerChoiceIndex, computerSymbol);
        freeCellIndexes.remove(i);
        return computerChoiceIndex;
    }

    public Line checkIfPersonWin() {
        if (checkIfWin(GameActivity.personSymbol)) {
            return lineIfWinner;
        }
        return new Line();
    }
